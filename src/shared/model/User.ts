...
export const buildPutUserParams = ({tenantId, sub, installation}: BuildPutUserParams): User => {
...
export const buildUserInstallation = ({userId, token, scopes}: User): UserInstallation => {
